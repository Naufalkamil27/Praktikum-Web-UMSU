...
darkToggle.textContent = aktif ? "🌙 Light Mode" : "🌙 Dark Mode";30
...
// Intersection Observer: pantau apakah elemen terlihat di layar33 const observer = new IntersectionObserver(
(entries) => {
